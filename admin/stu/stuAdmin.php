...
// 查询班级
$classSql = "select * from yefh_class";
$res = mysql_search($classSql,$connect);
...
<body style="background-color: #212529;">
	...
	<div id="stu_table">
		<div class="content">
			<p>当前位置：<i class="fa fa-users" aria-hidden="true"></i>&nbsp首页-->二级学院管理-->学生管理</p>
			<hr>
			...
			<table class="table table-hover" >
				...
				<tbody>
					<?php
						$i = 1;
						foreach ($res as $item) {
							$className = $item["stu_class"];
							//获取每个班级对应得学生数量
							$stuCountSql = "select count(1) from yefh_stu where stu_class = '{$className}'";
							$count = mysql_search($stuCountSql,$connect)[0]["count(1)"];
					?>
				    <tr>
					    ...
					    <td><a href="stuShow.php?class=<?php echo $item["stu_class"] ?>">查看班级学生</a></td>
				    </tr>
				    <?php
				    	$i ++;
				    	}
